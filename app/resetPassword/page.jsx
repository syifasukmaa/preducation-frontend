    ...
    <div className='flex flex-col lg:flex-row w-full min-h-screen'>
            ...
            <div className='p-8 lg:p-16 lg:w-2/3 flex items-center justify-center'>
                <div className='w-full lg:w-2/3'>
                    <h1 className='font-bold text-2xl text-DARKBLUE05 mb-8 lg:mb-12 text-left'>Reset Password</h1>
                    ...
                    {/* Login button */}
                    <button
                        className='text-white bg-DARKBLUE05 rounded-xl w-full p-2 mb-10'
                        onClick={validasi}
                    >
                        Masuk
                    </button>
