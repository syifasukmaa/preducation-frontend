...
export default function ModalUpdateUser({ onClose, token, userId, mutate, setShowModal }) {
  ...
  return (
    ...
    >
      <>
        <div className='flex items-center justify-between w-full gap-3 px-3 py-4 mt-4 '>
          <div className='flex flex-col items-center justify-center w-full gap-3 '>
            ...
            <label
              htmlFor='postFile'
              className='text-sm font-bold text-indigo-800 cursor-pointer dark:text-dark-grey-05'
            >
              Edit picture
            </label>
          </div>
