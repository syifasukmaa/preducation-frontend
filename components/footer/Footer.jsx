        ...
        <div className='flex justify-between gap-5 flex-col md:flex-row bg-primary-dark-blue p-10 text-center md:text-left'>
            ...
            <h2 className='font-bold text-white'>Kontak Kami</h2>
              ...
              <div className='flex gap-2 mx-auto md:mx-0 '>
                ...
                <Image
                  ...
                  height={10}
                  alt='location'/>
                <p href='#' className='text-white'>Jakarta</p>
              </div>
          ...
          <div className="flex flex-col gap-2 ">
            <h2 className='font-bold text-white'>Preducation</h2>
              ...
              <div className='flex gap-2 mx-auto md:mx-0 '>
                <a href='#' className='text-white cursor-pointer'>Tentang kelas</a>
              </div>

              <div className='flex gap-2 mx-auto md:mx-0'>
                <a href='#' className='text-white cursor-pointer'>Karir</a>
              </div>
          ...
          <div className="flex flex-col gap-2 ">
            <h2 className='font-bold text-white'>Layanan</h2>
              ...
              <div className='flex gap-2 mx-auto md:mx-0 '>
                <Link href='#' className='text-white cursor-pointer'>Kursus</Link>
              </div>

              <div className='flex gap-2 mx-auto md:mx-0'>
                <Link href='#' className='text-white cursor-pointer'>Kursus Populer</Link>
              </div>

              <div className='flex gap-2 mx-auto md:mx-0'>
                <Link href='#' className='text-white cursor-pointer'>Program</Link>
              </div>
          ...
          <div className="flex flex-col gap-2 ">
            <h2 className='font-bold text-white'>Bantuan</h2>
              ...
              <div className='flex gap-2 mx-auto md:mx-0 '>
                <Link href='#' className='text-white cursor-pointer'>FAQ</Link>
              </div>

              <div className='flex gap-2 mx-auto md:mx-0'>
                <Link href='#' className='text-white cursor-pointer'>Kebijakan Privasi</Link>
              </div>

              <div className='flex gap-2 mx-auto md:mx-0'>
                <Link href='#' className='text-white cursor-pointer'>Forum</Link>
              </div>
              <div className='flex gap-2 mx-auto md:mx-0'>
                <Link href='#' className='text-white cursor-pointer'>Syarat dan Ketentuan</Link>
              </div>
          </div>
